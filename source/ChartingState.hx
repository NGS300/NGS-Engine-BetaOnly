...
class ChartingState extends MusicBeatState{
	...
	override function create(){
		...
		informationText = new FlxText(1000, 3.75, 0, "", 16);
		...
		#if desktop
		DiscordClient.changePresence("Chart Editor", '\nTrack Charting: ' + _song.song, PlayState.instance.iconRPC, true);
		#end
	...
	var sussyLenght:Float = 1000000000; // Hold Notes Max, Numer Showing
	var maxSussy:Int = 1000; // Max NoteTypes Number Select in Charting
	var buttomScaleShit:Float = 0.8475;
	function addChartUIFACKYeah():Void{
		var noteTypePick:FlxUINumericStepper = new FlxUINumericStepper(5, 10, 1, 1, 0, maxSussy, 1);
		...
		var check_mute_vocal = new FlxUICheckBox(5, 325, null, null, "Mute Vocal", 100);
		...
		var check_mute_inst = new FlxUICheckBox(check_mute_vocal.x + 85, check_mute_vocal.y, null, null, "Mute Instrumental", 100);
	...
	function addSongUI():Void{
		var characters:Array<String> = CoolUtil.coolTextFile(Paths.txt('CharList', 'config'));
		var player1DropDown = new FlxUIDropDownMenu(-640, -18, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true), function(character:String){
			_song.player1 = characters[Std.parseInt(character)];
		});
		player1DropDown.selectedLabel = _song.player1;
		var player1LabelName = new FlxText(player1DropDown.x - 2, player1DropDown.y + 20, 'Player:');
		var player2DropDown = new FlxUIDropDownMenu(-510, -18, FlxUIDropDownMenu.makeStrIdLabelArray(characters, true), function(character:String){
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>){
		if (id == FlxUICheckBox.CLICK_EVENT){
			...
			}else if (wname == 'type_mechanicsNotes'){
	...
	override function update(elapsed:Float){
		...
		informationText.text = informationText.text = Std.string(FlxMath.roundDecimal(Conductor.songPosition / 1000, 2))
			+ " / "
	...
	function loadAudioBuffer(){
		...
		audioBuffers[0] = null;
		var leVocals:String = Paths.inst(_song.song);
		...
		audioBuffers[1] = null;
		var leVocals:String = Paths.voices(_song.song);
		if (OpenFlAssets.exists(leVocals)){
