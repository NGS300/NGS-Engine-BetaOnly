...
class FreeplayState extends MusicBeatState{
	...
	override function update(elapsed:Float){
		...
		if (accepted){
			var popedShit:String = Highscore.formatSong(songs[curSelected].songName.toLowerCase(), curDifficulty);
			trace(popedShit);
			PlayState.SONG = Song.loadFromJson(popedShit, songs[curSelected].songName.toLowerCase());
